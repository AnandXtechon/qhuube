...
export default function CorrectionStep({ onNext, onPrevious }: CorrectionStepProps) {
    const [issues, setIssues] = useState<TaxIssue[]>([
        ...
        },
        {
            ...
            vatAmount: 120.0,
            currency: "",
            issueType: "MISSING CURRENCY INFORMATION",
            originalValue: "",
            suggestedValue: "EUR",
            status: "pending",
            severity: "medium",
        },
        {
            ...
            vatAmount: 95.0,
            currency: "EUR",
            issueType: "MISSING SHIPPING INFORMATION",
            originalValue: "",
            suggestedValue: "Standard - UPS",
            status: "pending",
            severity: "low",
        },
        {
            ...
            vatAmount: 150.75,
            currency: "EUR",
            issueType: "MISSING PRODUCT TYPE",
            originalValue: "",
            suggestedValue: "Electronics",
            status: "pending",
            severity: "high",
        },
    ]);
