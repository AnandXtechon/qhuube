      ...
      <DialogContent className="sm:max-w-md bg-white border border-gray-200 shadow-xl">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-600">
            The file <span className="font-medium">{fileName}</span> requires manual VAT lookup processing.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-3">
            <div>
              <Label htmlFor="admin-email" className="text-sm font-medium text-gray-700 flex items-center gap-2">
                ...
                Admin Email for Manual Review
              </Label>
              <p className="text-xs text-gray-500 mt-1">
                Enter the admin email address to receive the manual review request and processed report within 24 hours
              </p>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-xs text-blue-800">
                ...
                <ul className="space-y-1 text-blue-700">
                  ...
                  <li>• The admin will receive the complete report via email within 24 hours</li>
                </ul>
              </div>
            </div>
          </div>
